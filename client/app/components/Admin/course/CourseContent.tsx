  ...
  return (
    <div className="w-[80%] m-auto mt-24 p-3">
      <form onSubmit={handleSubmit}>
                ...
                {showSectionInput && (
                  <>
                    <div className="flex items-center">
                      <input
                        ...
                        className={`text-[20px] ${
                          item.videoSection === "Untitled Section"
                            ? "w-[170px]"
                            : "w-min"
                        } font-Poppins cursor-pointer outline-none bg-transparent dark:text-white text-black`}
                        onChange={(e) => {
                          const updatedData = [...courseContentData];
                      ...
                      />
                      <BiSolidPencil className="cursor-pointer text-black dark:text-white" />
                    </div>
                    <br />
                  </>
                )}
        ...
        <br />
        <div className="flex items-center text-[20px] dark:text-white text-black cursor-pointer" onClick={()=>addNewSection}></div>
      </form>
    </div>
  );
};
