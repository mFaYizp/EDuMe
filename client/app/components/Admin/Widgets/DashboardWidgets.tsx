    ...
    <div className="mt-[30px] min-h-screen dark:text-white text-black">
      <div className="grid grid-cols-[75%,25%]">
        ...
        <div className="pt-[80px] pr-8">
          <div className="w-full bg-slate-50  dark:bg-[#111C43] rounded-sm shadow">
            <div className="flex items-center p-5 justify-between">
              <div className="">
                <BiBorderLeft className=" dark:text-[#45CBA0] Otext-[#000] text-[30px]" />
          ...
          <div className="w-full bg-slate-50  dark:bg-[#111C43] rounded-sm shadow my-8">
            <div className="flex items-center p-5 justify-between">
              <div className="">
                <PiUsersFourLight className=" dark:text-[#45CBA0] Otext-[#000] text-[30px]" />
                <h5 className="pt-2 font-Poppins dark:text-[#fff] text-black text-[20px]">
