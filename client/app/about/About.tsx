  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">EDuMe?</span>
      </h1>
      <br />
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          Are you ready to take your programming skills to the next level? Look
          no further than EDuMe, the premier programming community dedicated to
          helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of EDuMe, I know firsthand the challenges that
          come with learning and growing in the programming industry. That's why
          I created EDuMe H to provide new programmers with the resources and
          ...
          <br />
          <br />
          At EDuMe, we believe that price should never be a barrier to achieving
          ...
          <br />
          <br />
          But EDuMe is more than just a community - we're a family. Our
          ...
          <br />
          <br />
          With EDuMe by your side, there's nothing standing between you and your
          dream job. Our courses and community will provide you with the
          guidance, support, and motivation you need to unleash your full
          potential and become a skilled programmer.
          <br />
          <br />
          So what are you waiting for? Join the EDuMe family today and let's
